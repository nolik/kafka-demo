...
public class Rating extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 158209676528101045L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Rating\",\"namespace\":\"com.godeltech.com.kafkademo.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public static com.godeltech.com.kafkademo.schema.Rating.Builder newBuilder() {
    return new com.godeltech.com.kafkademo.schema.Rating.Builder();
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static com.godeltech.com.kafkademo.schema.Rating.Builder newBuilder(com.godeltech.com.kafkademo.schema.Rating.Builder other) {
    return new com.godeltech.com.kafkademo.schema.Rating.Builder(other);
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static com.godeltech.com.kafkademo.schema.Rating.Builder newBuilder(com.godeltech.com.kafkademo.schema.Rating other) {
    return new com.godeltech.com.kafkademo.schema.Rating.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Rating>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.godeltech.com.kafkademo.schema.Rating.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.godeltech.com.kafkademo.schema.Rating other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.godeltech.com.kafkademo.schema.Rating.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.godeltech.com.kafkademo.schema.Rating.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.godeltech.com.kafkademo.schema.Rating.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.godeltech.com.kafkademo.schema.Rating.Builder clearRating() {
